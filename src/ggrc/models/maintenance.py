...
class Maintenance(Identifiable, db.Model):
  ...
  is_revision_refresh_complete = db.Column(db.Boolean, nullable=False, default=True)
  is_reindex_complete = db.Column(db.Boolean, nullable=False, default=True)
  is_computed_attribute_complete = db.Column(db.Boolean, nullable=False, default=True)
